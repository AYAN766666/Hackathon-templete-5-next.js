...
import greenman from "../../../public/shop1.jpg";
  import gree from '../../../public/copyshop.jpg'
export default function GreenDiv() {
  return (
    <div className="w-full relative bg-[#23856D] rounded-[5px] py-[80px] flex justify-center  pt-11   ">
